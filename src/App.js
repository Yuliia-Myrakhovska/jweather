  ...
  useEffect(() => {
    ...
    getCoordinatesByCity()
      .then(() => {
        ...
        const interval = setInterval(handleRefreshWeather, 60 * 60 * 1000);
      ...
      <>
        ...
        <div className="container">
            ...
            <nav>
              ...
              {!isSmallScreen && (
                <ul className="nav__list">
                  <Link to="/jweather/selectedlocations">
                    <CitiLike />
                  </Link>
                  <Link to="/jweather/settings">
                    <Gear />
                  </Link>
                </ul>
              )}
          ...
          <main className="main-content">
            <Routes>
              <Route path="/jweather" element={<WeatherInfo />} />
              <Route
                exact
                path="/jweather/selectedlocations"
                element={
                  <SelectedLocations onRefreshWeather={handleRefreshWeather} />
                }
              />
              <Route exact path="/jweather/settings" element={<GearInfo />} />
            </Routes>
          </main>
        </div>
