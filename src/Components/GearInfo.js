...
function GearInfo() {
  ...
  return (
    <>
      <h1 className="settings-name-heading">Настройки</h1>
      <hr className="line" />
      ...
      <div className="settings-themeChange">
        <div className="themeChange-wrapper" onClick={openThemeModal}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      {isThemeModalOpen && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Выберите тему:</h3>
      ...
      {selectedMetric === "temperature" && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Температура</h3>
            <div className="modal-item-wraper">
              <input
                type="radio"
                id="°C"
      ...
      {selectedMetric === "length" && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Длина</h3>
            <div className="modal-item-wraper">
              <input
                type="radio"
                id="Meters"
      ...
      {selectedMetric === "pressure" && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Давление</h3>
            <div className="modal-item-wraper">
              <input
                type="radio"
      ...
      {selectedMetric === "speed" && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Скорость</h3>
            <div className="modal-item-wraper">
              <input
                type="radio"
                id="Meters_Second"
