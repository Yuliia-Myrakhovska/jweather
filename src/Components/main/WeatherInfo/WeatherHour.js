...
import { getweatherEvery2Hours } from '../../../proxy/weatherProxy';

function WeatherHour() {
  const weatherInfoEvery2Hours = getweatherEvery2Hours();

  useEffect(() => {
    const updateSwiper = () => {
      const swiper = new Swiper(".swiper-container-hour", {
        slidesPerView: 3,
        spaceBetween: 10,
        scrollbar: {
          el: ".swiper-scrollbar",
      ...
      {getweatherEvery2Hours() && (
        <div class="weather-forecast">
          ...
          <div class="swiper-container-wrapper">
            <div className="swiper-container swiper-container-hour">
              <div className="swiper-wrapper">
                {weatherInfoEvery2Hours.map((hourData, index) => (
                  <div
                    key={index}
                    class="swiper-slide swiper-slide-hour column"
                  >
                    <div class="time">{hourData.time}</div>
                    <div class="time-weather-img">
                      <img class="weather-icon-hour" src={require(`../../../img/icon/${hourData.icon}.svg`)} alt="" />
                    </div>
                    <div class="metric-text">{hourData.temp}</div>
